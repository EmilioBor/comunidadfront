// app/Donacion/ComunidadSolidaria/page.tsx
"use client";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center bg-fixed p-4" 
      ...
      <div className="bg-[#C5E9BE] rounded-2xl shadow-lg p-6 w-full max-w-md text-gray-800">
        ...
        {/* Tipo seleccionado desde parámetro */}
        {tipoParam && tipoSeleccionado && (
          <div className="bg-green-100 rounded-lg p-3 mb-4 border border-green-300 text-center">
            <p className="text-green-700 font-medium text-sm">
              Tipo: <span className="font-semibold">{tipoSeleccionado.descripcion}</span>
            </p>
            <p className="text-green-600 text-xs mt-1">Seleccionado desde la página principal</p>
          </div>
        )}
        ...
        <form onSubmit={handleCrearDonacion} className="space-y-4">
          ...
          {/* Tipo de Donación - Solo si no viene desde parámetro */}
          {!tipoParam && (
            <div>
          ...
          {/* Select oculto para mantener funcionalidad */}
          {tipoParam && (
